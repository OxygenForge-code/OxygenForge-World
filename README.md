...
Bazalt, toprak/çimen, kumtaşı, oksit bakır, ahşap ve meşale için yapay görsel üretimle hazırlanan 512×512 piksel-voxel texture materyalleri `client/public/textures/` altında tutulur ve Capacitor tarafından doğrudan APK asset'lerine kopyalanır. Texture'lar soğuk arduvaz bazaltını, zeytin-altın çimeni, bal-kumtaşı katmanlarını ve turkuaz patinalı oksit bakırı birbirinden açık biçimde ayıracak renk aralıklarıyla hazırlanmıştır. Küp yüzlerinde 0.45 UV ölçeğiyle büyütülür; mipmap, trilinear örnekleme ve 4× anizotropik filtreleme uzaktaki yüzeylerdeki titreşimli/kırık görünümü azaltır. Oyun uzak texture URL'si kullanmaz; renk fallback'i yalnızca beklenmeyen yerel dosya hatalarına karşı son güvenlik katmanıdır.
